...
var fetchNewToken = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, node_fetch_1.default(relayAddress + "/reservedHybridRelayCreate", { method: 'POST' })];
            case 1:
                res = _a.sent();
...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                if (!(!relayId || !relayToken)) return [3 /*break*/, 2];
                return [4 /*yield*/, fetchNewToken()];
            case 1:
                tokenInfo = _a.sent();
